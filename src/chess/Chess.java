...
public class Chess {
	public static void main(String[] args) {
        ...
        b.getSquares()[7][6].setOccupant(new Piece(new Type(eType.PAWN), 0, b));
        b.getSquares()[6][7].setOccupant(new Piece(new Type(eType.PAWN), 0, b));
		//White's front line
		...
		/*b.movePiece(b.getSquares()[0][1], 0, 2);
		b.drawBoard();*/
		
		//Location to check
		b.getSquares()[7][7].printAllowableMoves();
